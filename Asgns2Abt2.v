...
Lemma IMPLEMENTATIONs2_Abt2 :
forall (tt1_A1 tt1_A2 tt1_A1' tt2_A1 :nat)
       (loc_11 loc_21 loc_31 loc_42 loc_53 :nat)
       (loc_52 :nat)
       (loc_41 loc_51 loc_43 :nat),

neq0_tt4 tt1_A2 tt1_A1' tt1_A1 tt2_A1 ->
neq0_loc9 loc_11 loc_21 loc_31 loc_42 loc_53 loc_52 loc_41 loc_51 loc_43 ->

neq_t4 t1_A1' t1_A1 t1_A2 t2_A1 ->
neq_tt4 tt1_A2 tt1_A1' tt1_A1 tt2_A1 ->
neq_loc9 loc_11 loc_21 loc_31 loc_42 loc_53 loc_52 loc_41 loc_51 loc_43 ->
(null_sV,
...
t1_A2 !st-> tt1_A2; t2_A1 !st-> tt2_A1; t1_A1' !st-> tt1_A1'; t1_A1 !st-> tt1_A1; null_sT,
...
Proof.
  ...
  intros loc_11 loc_21 loc_31 loc_42 loc_53 loc_52 loc_41 loc_51 loc_43.
  intros [H [H0 [H1 H2]]].
  ...
  - eapply E_Seq.
    ...
    eapply E_Seq.
    eapply E_Tplan with (tloc := tt1_A2) (loc := loc_43).
    reflexivity. rewrite hV_update_neq. rewrite hV_update_neq.
    apply hV_update_neq. auto. auto. auto.
    rewrite hT_update_neq. reflexivity. auto.
    rewrite sT_update_shadow_4. simpl.

    eapply E_Seq.
    eapply E_Tadd with (tloc := tt1_A2) (loc := loc_52).
    reflexivity. rewrite hT_update_eq. reflexivity.
    intros l L0.
    apply Inlist in L0. exists (Some 1301).
    rewrite L0. rewrite hV_update_eq. reflexivity.
    reflexivity. rewrite hV_update_neq. rewrite hV_update_neq.
