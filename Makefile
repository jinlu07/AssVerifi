...
Makefile.conf: _CoqProject
	coq_makefile -f _CoqProject Aid.v AsgnComps1.v Asgns1.v Asgns2.v Asgns2Abt1.v Asgns2Abt2.v CSSsVerification.v language.v removestatehv.v SafeinHt.v SafeinSs.v semantic.v state.v util.v -o Makefile
